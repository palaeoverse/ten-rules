...
By default, when we read data tables into R, any cells which are empty are filled with `NA` (meaning 'not applicable'). Because of this, typically when we want to find missing values, we need to search for values which are `NA`. 
