...
#install.packages(c("dplyr", "palaeoverse", "readr", "ggplot2", "deeptime", "rnaturalearth", "rnaturalearthdata"))
library(dplyr)
library(palaeoverse)
library(readr)
library(ggplot2)
...
Next we want to focus in on the specific parameters which relate to our scientific question, i.e. the geography of our fossil occurrences. First we'll plot where the crocodile fossils have been found across the globe.
